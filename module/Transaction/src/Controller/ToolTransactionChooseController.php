...
class ToolTransactionChooseController extends AbstractActionController
{
    private $sm;
    private $misc;
    private $viewModel;
    ...
    protected function toolTransactionChoose()
    {
        $from = [];
    ...
    public function toolreceiveAction()
    {
        ...
        $this->viewModel->setTemplate('transaction/tool-transaction-choose/_tool-transaction-choose.phtml');
        $this->misc['from'] = $this->em->getRepository(Storage::class)->findby(['storageType' => 4], ['name' => 'ASC']);
        $this->misc['to'] = $this->em->getRepository(Storage::class)->getRealStorage(['tool']);
        $this->misc['title'] = "Eszköz bevételezés";

        return $this->toolTransactionChoose();
    }
    ...
    {
        $this->viewModel->setTemplate('transaction/tool-transaction-choose/_tool-transaction-choose.phtml');
        $this->misc['from'] = $this->em->getRepository(Storage::class)->getRealStorage(['tool']);
        $this->misc['to'] = $this->em->getRepository(Storage::class)->findby(['storageType' => 4], ['name' => 'ASC']);
        $this->misc['title'] = "Eszköz visszárú";
    ...
    public function toolmoveAction()
    {
        ...
        $this->misc['from'] = $this->em->getRepository(Storage::class)->getRealStorage(['tool']);
        $this->misc['to'] = $this->em->getRepository(Storage::class)->getRealStorage(['tool']);
        $this->misc['title'] = "Eszköz átvételezés";
    ...
    public function tooldiscardAction()
    {
        ...
        $this->misc['title'] = "Eszköz selejtezés";
    ...
    public function toolstockcorrectionAction()
    {
        ...
        $this->misc['from'] = $this->em->getRepository(Storage::class)->getRealStorage(['tool']);
        $this->misc['to'] = $this->em->getRepository(Storage::class)->getRealStorage(['tool']);
        $this->misc['title'] = "Eszköz készletkorrekció (leltár)";
    ...
    public function tooluniversalAction()
    {
        ...
        $this->misc['title'] = "Univerzális eszköz-mozgatás";
