...
/**
 * @Entity(repositoryClass="Transaction\Repository\StockRepository")
 * @Table(name="tra_stock")
 */
class Stock extends ServiceMangerAwareEntity
{
    ...
    /**
     * @ManyToOne(targetEntity="Catalog\Entity\Storage", inversedBy="stock", fetch="EAGER")
    ...
    /**
     * Ezt azért nem ingrdeientnek neveztem el, mert a toolnak pénznek stb is kell egy stockk és ugyanúfy itemnek kell lennie
     * @ManyToOne(targetEntity="Catalog\Entity\Ingredient", inversedBy="stock", fetch="EAGER")
