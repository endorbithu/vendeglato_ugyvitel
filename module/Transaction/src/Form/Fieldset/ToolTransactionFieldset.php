...
class ToolTransactionFieldset extends Fieldset implements InputFilterProviderInterface
{
    ...
    public function __construct($em, $entity)
    {
        ...
        $this->add([
            ...
            'type' => 'hidden',
            'attributes' => [
                'id' => 'tool-transaction-tool-transaction-type',
        ...
        $this->add([
            ...
            'type' => 'hidden',
            'attributes' => [
                'id' => 'tool-transaction-from-storage',
        ...
        $this->add([
            ...
            'type' => 'hidden',
            'attributes' => [
                'id' => 'tool-transaction-to-storage',
