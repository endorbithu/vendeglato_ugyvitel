...
class IngredientTransactionChooseController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        //Itt is fel lesznek sorolva az egyes tranzakciók
    ...
    public function receiveAction()
    {
        ...
        $this->viewModel->setTemplate('catalog/ingr-transaction-choose/_ingr-transaction-choose.phtml');
        $this->misc['from'] = $this->em->getRepository(Storage::class)->findby(['storageType' => 4], ['name' => 'ASC']);
        $this->misc['to'] = $this->em->getRepository(Storage::class)->getRealStorage();
        $this->misc['title'] = "Bevételezés";
    ...
    {
        $this->viewModel->setTemplate('catalog/ingr-transaction-choose/_ingr-transaction-choose.phtml');
        $this->misc['from'] = $this->em->getRepository(Storage::class)->getRealStorage();
        $this->misc['to'] = $this->em->getRepository(Storage::class)->findby(['storageType' => 4], ['name' => 'ASC']);
        $this->misc['title'] = "Visszárú";
    ...
    public function universalAction()
    {
        ...
        $this->misc['title'] = "Alapanyag mozgatás";
