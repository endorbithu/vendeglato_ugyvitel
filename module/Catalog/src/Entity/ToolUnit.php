...
class ToolUnit
{
    ...
    /**
     * @OneToMany(targetEntity="Tool", mappedBy="toolUnit")
     **/
    private $tool;
    ...
    {
        $arrayCopy = [];
        $arrayCopy['ToolUnit'] = get_object_vars($this);
        if (array_key_exists('sm', $arrayCopy['ToolUnit'])) {
            unset($arrayCopy['ToolUnit']['sm']);
        }
        return $arrayCopy;
    }
