...
/**
 * @Entity(repositoryClass="Catalog\Repository\StockTransactionRepository")
 * @Table(name="cat_stock_transaction")
 */
class StockTransaction extends ServiceMangerAwareEntity
{
    ...
    /**
     * @ManyToOne(targetEntity="Storage", inversedBy="stockTransactionFrom", fetch="EAGER")
    ...
    /**
     * @ManyToOne(targetEntity="Storage", inversedBy="stockTransactionTo", fetch="EAGER")
