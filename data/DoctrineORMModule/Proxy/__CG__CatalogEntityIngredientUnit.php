 ...
 */
class IngredientUnit extends \Catalog\Entity\IngredientUnit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Catalog\\Entity\\IngredientUnit' . "\0" . 'id', '' . "\0" . 'Catalog\\Entity\\IngredientUnit' . "\0" . 'name', '' . "\0" . 'Catalog\\Entity\\IngredientUnit' . "\0" . 'shortName', '' . "\0" . 'Catalog\\Entity\\IngredientUnit' . "\0" . 'ingredient', '' . "\0" . 'Catalog\\Entity\\IngredientUnit' . "\0" . 'isDecimal'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IngredientUnit $proxy) {
    ...
    public function getIsDecimal()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIsDecimal', []);

        return parent::getIsDecimal();
    }
    ...
    public function setIsDecimal($isDecimal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIsDecimal', [$isDecimal]);

        return parent::setIsDecimal($isDecimal);
    }
