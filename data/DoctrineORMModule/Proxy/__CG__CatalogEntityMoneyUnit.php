 ...
 */
class MoneyUnit extends \Catalog\Entity\MoneyUnit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Catalog\\Entity\\MoneyUnit' . "\0" . 'id', '' . "\0" . 'Catalog\\Entity\\MoneyUnit' . "\0" . 'name', '' . "\0" . 'Catalog\\Entity\\MoneyUnit' . "\0" . 'shortName', '' . "\0" . 'Catalog\\Entity\\MoneyUnit' . "\0" . 'isDecimal', '' . "\0" . 'Catalog\\Entity\\MoneyUnit' . "\0" . 'money'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MoneyUnit $proxy) {
