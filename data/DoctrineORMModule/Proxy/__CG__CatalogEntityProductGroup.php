 ...
 */
class ProductGroup extends \Catalog\Entity\ProductGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Catalog\\Entity\\ProductGroup' . "\0" . 'id', '' . "\0" . 'Catalog\\Entity\\ProductGroup' . "\0" . 'name', '' . "\0" . 'Catalog\\Entity\\ProductGroup' . "\0" . 'product'];
        }
