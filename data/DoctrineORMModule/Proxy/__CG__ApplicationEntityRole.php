...
class Role extends \Application\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'displayName', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'user'];
        }
