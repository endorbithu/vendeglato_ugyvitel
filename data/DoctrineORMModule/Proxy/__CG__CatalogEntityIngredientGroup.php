 ...
 */
class IngredientGroup extends \Catalog\Entity\IngredientGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Catalog\\Entity\\IngredientGroup' . "\0" . 'id', '' . "\0" . 'Catalog\\Entity\\IngredientGroup' . "\0" . 'name', '' . "\0" . 'Catalog\\Entity\\IngredientGroup' . "\0" . 'ingredient'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IngredientGroup $proxy) {
