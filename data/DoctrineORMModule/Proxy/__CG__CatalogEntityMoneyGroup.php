 ...
 */
class MoneyGroup extends \Catalog\Entity\MoneyGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Catalog\\Entity\\MoneyGroup' . "\0" . 'id', '' . "\0" . 'Catalog\\Entity\\MoneyGroup' . "\0" . 'name', '' . "\0" . 'Catalog\\Entity\\MoneyGroup' . "\0" . 'money'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MoneyGroup $proxy) {
